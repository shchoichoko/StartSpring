...
public class EventModifyCommand implements Command {
...
//		Event DB
		...
		if(img_cover != null) dao.modifyDAO(no, 1, img_cover);
		if(img_contents != null) dao.modifyDAO(no, 2, img_contents);
		
		System.out.println(no);
		System.out.println(img_cover);
		System.out.println(img_contents);
	}
